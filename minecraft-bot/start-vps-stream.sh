...
stream_to_platform() {
    ...
    ffmpeg \
        ...
        -vf "drawtext=text='${PLATFORM_NAME} - Minecraft Bot Training | Episode: N/A | Reward: N/A | Stage: gathering':fontsize=24:fontcolor=white:x=(w-text_w)/2:y=(h-text_h)/2:box=1:boxcolor=black@0.5" \
        -vcodec libx264 \
        -preset veryfast \
        -b:v ${BITRATE} \
        -maxrate ${BITRATE} \
